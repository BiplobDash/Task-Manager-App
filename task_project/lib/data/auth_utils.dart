...
class AuthUtils {
  static String? firstName, lastName, token, profilePic, mobile;

  static Future<void> saveUserData(String uFirstName, String uLastName,
      String uToken, String uProfilePic, String uMobile) async {
  ...
  static Future<void> getAuthData() async {
    ...
    mobile = sharedPreferences.getString('mobbile');
  }
}
